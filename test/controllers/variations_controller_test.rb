...
class VariationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variation" do
    assert_difference('Variation.count') do
      post variations_url, params: { variation: { book_id: @variation.book_id, kind: @variation.kind } }
    end
  ...
  test "should update variation" do
    patch variation_url(@variation), params: { variation: { book_id: @variation.book_id, kind: @variation.kind } }
